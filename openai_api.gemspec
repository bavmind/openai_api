...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Unofficial OpenAI API Client"
  spec.description = "An unofficial client for the OpenAI API."
  ...
  spec.metadata["source_code_uri"] = "https://github.com/bavmind/openai_api"
  spec.metadata["changelog_uri"] = "https://github.com/bavmind/openai_api/blob/main/CHANGELOG.md"
